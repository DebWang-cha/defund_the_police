...
funds = T.AllFunds2020.*10^-6;  % US$ millions
...
title({'2020 Annual Operating Plan', 'St. Louis, MO', '\fontsize{18} Partial Budget'});
xlabel({'US$ Millions', '\fontsize{8} Source: FY 2020 Annual Operating Plan - City of St. Louis'});
ax=gca;
ax.XGrid='on';
