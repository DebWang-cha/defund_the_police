% Partial FY2020 Budget for Richmond, VA (General Fund) as a Bar Chart
...
title({'2020 General Fund', "Richmond, VA", '\fontsize{18} Partial Budget'});
xlabel({'US$ Millions', "\fontsize{8} Source: FY 2019-20 Adopted Biennial Fiscal Plan - City of Richmond"});
ax=gca;
ax.XGrid='on';
