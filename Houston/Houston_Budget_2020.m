% Partial FY2020 Budget for Houston, TX (General Fund) as a Bar Chart
...
title({'FY2020 General Fund', 'Houston, TX', '\fontsize{18} Partial Budget'});
xlabel({'US$ Millions', '\fontsize{8} Source: FY 2020 Budget General Fund Summary - City of Houston' });
ax=gca;
ax.XGrid='on';
