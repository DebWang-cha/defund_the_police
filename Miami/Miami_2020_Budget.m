% Partial FY2020 Budget for Miami, FL (General Fund) as a Bar Chart
...
title({'2020 General Fund', "Miami, FL", '\fontsize{18} Partial Budget'});
xlabel({'US$ Millions', "\fontsize{8} Source: FY 2019-20 Adopted Budget in Brief - City of Miami"});
ax=gca;
ax.XGrid='on';
